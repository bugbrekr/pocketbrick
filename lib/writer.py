...
class Writer():
    ...
    def __init__(self, device, font, width, height, verbose=True):
        ...
        self.font = font
        if font.height() >= self.screenheight or font.max_width() >= self.screenwidth:
        ...
        if verbose:
            ...
            print(fstr.format(font.reverse(), self.screenwidth, self.screenheight))
    ...
    def _get_char(self, char, recurse):
        ...
        return (bytearray(glyph), self.char_width, char_height)
